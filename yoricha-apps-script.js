...
var STAFF_PASSWORD  = '1234';   // Mã nhân viên 1 (chủ / quản lý)
var STAFF_PASSWORD2 = '5678';   // Mã nhân viên 2 — đổi thành mã bạn muốn
...
function authStaff(password) {
  return password === STAFF_PASSWORD || password === STAFF_PASSWORD2;
}
